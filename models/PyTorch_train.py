...
def train_eval(net,
    ...
    """
    Train the PyTorch model using the eval set and evaluate its performance on the eval set. This function essentially
        ...
        for i_batch, batches in enumerate(zip_recycle(*train_loaders)):
            ...
            for i_task, task_batch in enumerate(batches):
                ...
                if scale_loss_task_size is None:
                    ...
                    losses_task[i_task] = loss_task * len(task_batch[0])
