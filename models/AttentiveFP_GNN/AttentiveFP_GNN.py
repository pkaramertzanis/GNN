...
class AttentiveFP_GNN(torch.nn.Module):
    ...
    Args:
        num_node_features (int): Size of each input sample.
        hidden_channels (int): Hidden node feature dimensionality.
        n_classes: array with the number of output classes in each classification task
        num_edge_features (int): Edge feature dimensionality.
    ...
    def __init__(
        ...
        self.gate_conv = GATEConv(hidden_channels, hidden_channels, num_edge_features,
                                  dropout)
        ...
        for n_class in self.n_classes:
            self.out_layers.append(torch.nn.Linear(hidden_channels, n_class))
